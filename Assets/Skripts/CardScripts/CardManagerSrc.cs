...
public class CardManagerSrc : MonoBehaviour
{
    ...
    public static void GenerateCards()
    {
        ...
        CardManagerSrc.AllUnitCards.Add(new UnitCard("×àñû", Element.Time, "Ñharacters/time/time_clock", 0, 6, 2));
        ...
        CardManagerSrc.AllMassiveTargetSpellCards.Add(new MassiveTargetSpell("Ëå÷åíèå", "Ñharacters/void/texture_void_bug", 2, (Game Game, Card Card) =>
        {
            Card.PlayerBase.Heal(3);
        }));
        CardManagerSrc.AllSingleTargetCards.Add(new SingleTargetSpellCard("3 óðîíà", "Ñharacters/void/texture_void_dog", 2, (ITarget it) =>
        {
            it.TakeDamage(3);
            it.TakeHeal(2);
        }));
